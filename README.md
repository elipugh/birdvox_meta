# This repo is for a Stanford CS224S Final Project, as well as for the DCASE 2021 Few-shot Bioacoustic Event Detection challenge!

I forked this from [https://github.com/c4dm/dcase-few-shot-bioacoustic](https://github.com/c4dm/dcase-few-shot-bioacoustic), and added an LSTM, Dilated CNN, and Transformer models.

Check out a nice [Google Colab Notebook](https://colab.research.google.com/drive/1mxgjBUPkYyLqmqgzdQaIdFumYz-F2PNR?usp=sharing) showing how to use this repository!
...
| CNN | 35.10 | 52.61 | 26.33 |
| Dilated CNN | 42.25 | 48.25 | 37.58 |
| Pyramidal LSTM | 4.34 | 2.00 | 25.95 |
| Transformer | 26.53 | 29.32 | 24.22 |

Here's a nice visualization of the prototypes learned by a Dilated CNN

![](figures/centroids.png)

This repo contains the Prototypical Network approach  (<a href="https://arxiv.org/abs/1703.05175">Snell et. al in 2017</a>).  This intuitively is learning an embedding network to pass examples through, where examples in the same class are close in embedding space.  During testing, only a few examples of each class are passed through, and a mean centroid is taken of the embeddings of each class.  Unseen examples are classified as the centroid of shortest Euclidean distance. Negative centroids are created by negative sampling.  See [here](https://github.com/c4dm/dcase-few-shot-bioacoustic/tree/main/baselines/deep_learning) for more info.
...
<p align="center"><img src="https://github.com/c4dm/dcase-few-shot-bioacoustic/blob/master/figures/VM.png" alt="figure" width="500"/></p>
